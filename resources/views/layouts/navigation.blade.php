            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-3">
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-full bg-gradient-to-r from-navy-50 to-navy-100 text-navy-900 hover:from-navy-100 hover:to-navy-200 focus:outline-none transition-all duration-300 shadow-sm hover:shadow">
